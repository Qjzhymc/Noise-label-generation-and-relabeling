...
if __name__=='__main__':
	#1.获取数据集，添加噪声标签
	dataset=arff.loadarff('scene-train.arff')#数据593行，78列，
	...
	train_y=y
	train_z=z
	print(train_x.shape)#1211行，294列
	...
	#train_data加入s，并写入文件
	train_data['s']=s
	train_data.to_csv('scene.csv',index=None)
